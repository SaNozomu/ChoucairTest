package co.com.choucair.certification.choucairproject.stepdefinitions;


import co.com.choucair.certification.choucairproject.model.Data;
import co.com.choucair.certification.choucairproject.questions.Answer;
import co.com.choucair.certification.choucairproject.tasks.*;
...
public class RegisterStepDefinitions {
    ...
    public void he_fills_the_about_yourself_form(List<Data>challengeData) throws Exception {
    ...
    public void he_adds_your_address_information(List<Data>challengeData) throws Exception {
    ...
    public void he_inserts_and_confirms_the_login_password_and_accepts_terms_and_policies(List<Data>challengeData) throws Exception {
    ...
    public void he_is_already_see_the_welcome_message(List<Data>challengeData) throws Exception {
